    ...
    <div className="app-card rounded-3xl border dark:border-white/10 dark:bg-white/5 backdrop-blur-xl p-6">
      ...
      <div className="grid sm:grid-cols-2 gap-5">
        ...
        <div>
          ...
          <label className="app-text-muted text-sm dark:text-slate-400 block mb-3">
            Full Name*
          </label>
          ...
          <input
            ...
            className="app-text-muted w-full h-12 rounded-2xl dark:bg-slate-900 border dark:border-white/10 px-4 outline-none focus:border-indigo-500 transition"
          />
