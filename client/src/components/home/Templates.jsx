...
const Templates = () => {
  ...
  return (
    <section id="templates" className="py-28 bg-slate-950 text-white">
          ...
          {templates.map((template, index) => (
            ...
            >
              ...
              <div className="mt-6">
                ...
                {/* Button */}
                <button onClick={()=>navigate('/login')} className="w-full py-3 rounded-2xl bg-linear-to-r from-indigo-500 to-purple-500 hover:opacity-90 transition-all duration-300">
