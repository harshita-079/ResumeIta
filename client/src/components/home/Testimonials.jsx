...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-28 bg-slate-950 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-8 mb-16">
          ...
          {/* Right */}
          <button onClick={handleFeedback} className="px-6 py-3 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl hover:bg-white/10 transition-all duration-300">
